...
//  SCL         接        P65           //电容触摸屏IIC总线时钟引脚
//  RST         接        P63           //电容触摸屏IC复位控制引脚（低电平复位）
//  INT         接        P32           //电容触摸屏中断检测引脚（发生触摸时为低电平）
//**************************************************************************************************/		
...
sbit RST_CTRL = P6^3;	//GT911 RESET pin out high or low
sbit INT_CTRL = P3^2; //GT911 INT pin out high or low
