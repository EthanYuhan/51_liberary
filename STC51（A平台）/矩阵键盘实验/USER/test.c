...
void main_test(void)
{
	...
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2019-06-20",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
...
{	
	...
	Show_Str(10,30,BLUE,YELLOW,"16X16:学蠡科技欢迎您",16,0);
	Show_Str(10,50,BLUE,YELLOW,"16X16:Welcome学蠡科技",16,0);
	Show_Str(10,70,BLUE,YELLOW,"24X24:学蠡中文测试",24,1);
	Show_Str(10,100,BLUE,YELLOW,"32X32:学蠡字体测试",32,1);
	delay_ms(1200);
}
