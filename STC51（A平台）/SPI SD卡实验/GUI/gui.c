...
void number(u8 x,u16 y,u32 dat,u16 dcolor,u16 bgcolor)				//坐标 要显示的数据	   跟踪程序数据用
{
 ...
 take[0]=dat/10000%10+'0'; 
 take[1]=dat/1000%10+'0';
 take[2]=dat/100%10+'0';
 take[3]=dat/10%10+'0';
 take[4]=dat%10+'0';
 ...
 for(i=0;i<m;i++)			  //显示
 {
		...
		LCD_ShowChar(x+i*8,y,dcolor,bgcolor,take[5-m+i],16,0);			  //+'0'表示转换为ACCII码
 }
...
void number10(u8 x,u16 y,u16 dat,u16 dcolor,u16 bgcolor)	//坐标 要显示的数据	 
{
   ...
   sprintf((char *)buf,"%d",(dat/10%10));	
   Show_Str(x,y,dcolor,bgcolor,buf,16,0);
	
   sprintf((char *)buf,"%d",(dat%10));	
   Show_Str(x+8,y,dcolor,bgcolor,buf,16,0);
}
